// -----------------------------------------------------------------------------------
// Prepared by Touhid Taj : +88 01787188885, https://zaap.bio/TouhidDesign
...
jQuery.fn.wowSlider = function (am) {
        ...
        function (k) {
          var f =
            /ws_playpause|ws_prev|ws_next|ws_bullets/g.test(
              k.target.className
            ) || aI(k.target).parents(".ws_bullets").get(0);
      ...
      for (var bl = 0; bl < 2; bl++) {
        ...
        if (bg < 0) {
          var bh,
            bj,
            bn =
              (bm[bl ? "pageX" : "pageY"] - ao.offset()[bl ? "left" : "top"]) /
              bq;
          if (bb == bn) {
            return;
          }
      ...
      if (a1.length) {
        ...
        function bc(bi) {
          ...
          var bj = {
            ...
            "margin-bottom":
              -a8.get(bi).offsetTop + a8.get(a8.length - 1).offsetTop + "px",
          };
          var bh = a1.get(bi);
          var bg = {
            left:
              -bh.offsetLeft +
              (aI(bh).outerWidth(true) - aI(bh).outerWidth()) / 2,
          };
          if (a4 < 0) {
            a3.css(bj);
            a9.css(bg);
        ...
        if (!aw) {
          ...
          for (var a1 = 0; a1 <= 1; a1++) {
            if (a1) {
              ...
              var a0 = ag
                ? a5.width()
                : aI(a4.get(0)).outerWidth(true) * a4.length;
            } else {
              var a0 = a5.height();
            }
            ...
            if (f < 0) {
              if (a1) {
                a5.stop(true).animate({
                  left: -Math.max(
                    Math.min(a2.left, -a6.left),
                    a2.left + k.outerWidth(true) - ao.width()
                  ),
                });
              } else {
                a5.stop(true).animate({
                  top: -Math.max(
                    Math.min(a2.top, 0),
                    a2.top + k.outerHeight(true) - ao.height()
                  ),
                });
              }
            } else {
  ...
  function aX(f, a1, c) {
    ...
    (ac[aI.type(k)] || ac[k] || ac.none)(
      aI.extend({ $this: H, curIdx: x, prevIdx: ax, noDelay: c }, am),
      D,
      aF,
      a0,
      a2,
  ...
  if (u) {
    ...
    if (window.Audio && u.canPlayType && u.canPlayType("audio/mp3")) {
      ...
      swfobject.createSWF(
        { data: ab + "player_mp3_js.swf", width: "1", height: "1" },
        {
...
jQuery.fn.wowSlider.support = {
  ...
  perspective: (function () {
    var b =
      "perspectiveProperty perspective WebkitPerspective MozPerspective OPerspective MsPerspective".split(
        " "
      );
